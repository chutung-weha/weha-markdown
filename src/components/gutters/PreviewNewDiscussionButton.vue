<template>
  <a class="new-discussion-button" href="javascript:void(0)" v-if="coordinates" :style="{top: coordinates.top + 'px'}" v-title="'Bắt đầu thảo luận'" @mousedown.stop.prevent @click="createNewDiscussion(selection)">
