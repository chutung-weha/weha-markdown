<template>
  <modal-inner class="modal__inner-1--google-photo" aria-label="Nhập Google Photo">
    <div class="modal__content">
      <div class="google-photo__tumbnail" :style="{backgroundImage: thumbnailUrl}"></div>
      <form-entry label="Tiêu đề" info="tuỳ chọn">
        <input slot="field" class="textfield" type="text" v-model.trim="title" @keydown.enter="resolve()">
      </form-entry>
      <form-entry label="Giới hạn kích thước" info="tuỳ chọn">
